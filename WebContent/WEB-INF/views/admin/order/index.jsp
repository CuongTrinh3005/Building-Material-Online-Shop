...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<article>
				<div class="row">
					<h1 class="col-sm-11">Thông tin đơn đặt hàng</h1>		
				</div>
					...
					<tbody>
						<c:forEach var="o" items="${orders}">
							<tr>
								...
								<td>
									<a href="admin/order/detail/${o.getOrderId()}.htm">
										<button class="btn btn-info">Detail</button>
									</a>
								</td>
								<td>
									<a href="admin/order/update/${o.getOrderId()}.htm">
										<button class="btn btn-warning">Edit</button>
									</a>
								</td>
								<td>
									<a href="admin/order/delete/${o.getOrderId()}.htm">

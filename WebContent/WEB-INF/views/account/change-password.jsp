	...
	<div class="container">
		...
		<div class="row">
			<article class="col-sm-9">
				...
				<h4>${message}</h4>
				<div>
					<form action="account/change-password.htm" method="post">
						...
						<div class="form-group">
							...
							<br>
							<input type="password" name="pw" value="${param.pw}">
							<p class="message_err_pw">${message_err_pw}</p>
						</div>
						<div class="form-group">
							<label>New password: </label>
							<br>
							<input type="password" name="pw1" value="${param.pw1}">
							<p class="message_err_pw1">${message_err_pw1}</p>
						</div>
						<div class="form-group">
							<label>Confirm password: </label>
							<br>
							<input type="password" name="pw2" value="${param.pw2}">
							<p class="message_err_pw2">${message_err_pw2}</p>
						</div>
						<div class="form-group">
